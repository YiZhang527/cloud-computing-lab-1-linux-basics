...
echo "This is file1" > "${PROJECT_DIR}/data/file1.txt"
echo "This is file2" > "${PROJECT_DIR}/data/file2.txt"
echo "This is file3" > "${PROJECT_DIR}/data/file3.txt"
echo "This is file4" > "${PROJECT_DIR}/data/file4.txt"
echo "This is file5" > "${PROJECT_DIR}/data/file5.txt"
...
rm -f "${PROJECT_DIR}/scripts/file1_link.txt"
...
TODAY=$(date +%Y%m%d)
tar -czf "backup_${TODAY}.tar.gz" "${PROJECT_DIR}/backup"
mv "backup_${TODAY}.tar.gz" "${PROJECT_DIR}/backup"
